...
import {allExercises, getAllExercisesWithDetails, exercisesByID, viewAllExercises, viewAllExercisesByID } from "../controllers/exercises.controller.js";
...
router.get('/view-exercises/:id', viewAllExercisesByID) //Muestra un ejercicio en específico por su ID guardados en la base de datos del sistema
